...
def generate_text(model, start_string):
    ...
    for i in range(num_generate):
        test = tf.squeeze(input_eval,0)
        predictions = tf.dtypes.cast(input_eval, tf.float32)
...
vector_file =dirpath+"/output_file_12.txt"
word2indx, idx2word = make_indices(vector_file)
print('################################################################')
print(generate_text(pipikaka, start_string='we wandelen in de'))